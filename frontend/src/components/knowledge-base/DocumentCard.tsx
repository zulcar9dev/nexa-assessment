                ...
                className={`h-1.5 ${
                    doc.kategori === "KREDIT_FLEKSI"
                        ...
                        : doc.kategori === "KREDIT_GRIYA"
                          ? "bg-gradient-to-r from-[#00665e] to-[#004d47]"
                          : "bg-gradient-to-r from-[#f15a23] to-[#d1400b]"
                }`}
            />
                ...
                <div className="flex items-start gap-3 mb-3">
                    ...
                    <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap gap-1.5 mb-1.5">
                            <span className="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-[#e0f2f1] text-[#00665e] dark:bg-[#00665e]/20 dark:text-[#80cbc4]">
                ...
                <div className="flex items-center gap-2 pt-3 border-t border-gray-100 dark:border-[#444564]">
                    <Link
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2
                            ...
                            border border-[#00665e] text-[#00665e] dark:border-[#80cbc4] dark:text-[#80cbc4]
                            hover:bg-[#00665e] hover:!text-white dark:hover:bg-[#80cbc4] dark:hover:!text-[#232333]
                    ...
                    <button
                        ...
                        className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2
                            text-xs font-medium rounded-lg
                            border border-[#f15a23] text-[#f15a23]
