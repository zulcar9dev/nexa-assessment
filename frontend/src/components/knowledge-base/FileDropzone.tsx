            ...
            {!file ? (
                <div
                    ...
                    className={`
                        ...
                        ${isDragging
                            ? "border-[#00665e] bg-[#e0f2f1] dark:bg-[#00665e]/10 scale-[1.02]"
                            : "border-gray-300 dark:border-[#444564] hover:border-[#00665e] hover:bg-gray-50 dark:hover:bg-[#323249]"
                        }
                    `}
                >
                    <Upload
                ...
                <div
                    className="flex items-center gap-3 p-4 rounded-xl
                        bg-[#e0f2f1] dark:bg-[#00665e]/10
                        border border-[#00665e]/30 dark:border-[#80cbc4]/30
                        animate-fade-in"
                >
