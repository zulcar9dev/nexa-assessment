...
export default React.memo(function TabAIdentitas() {
    ...
    const dokumenLabel = useMemo(() => {
        switch (formData.status_perkawinan) {
            case "menikah":
                return "Kutipan Akta Nikah";
            case "belum_menikah":
                return "Surat Keterangan Belum Menikah";
            case "cerai_hidup":
                return "Akta Cerai";
            case "cerai_mati":
                return "Akta Kematian Pasangan";
            default:
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => {
                                    updateField("status_perkawinan", e.target.value);
                        ...
                        {formData.status_perkawinan && formData.status_perkawinan !== "" && (
                            <>
                                {/* Nomor Dokumen */}
                                <div>
                                    <label
                                    ...
                                    <input
                                        id="no_dokumen_status_perkawinan"
                                        name="no_dokumen_status_perkawinan"
                                        type="text"
                                ...
                                <div>
                                    ...
                                    <input
                                        id="tgl_dokumen_status_perkawinan"
                                        name="tgl_dokumen_status_perkawinan"
                                        type="date"
