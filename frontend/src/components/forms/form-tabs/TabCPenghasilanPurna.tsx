          ...
          <div className="grid grid-cols-2 gap-4">
            <label
              className={`flex items-center gap-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                (formData.purna_penghasilan_mode || "minimum") === "minimum"
                  ? "border-[#00665e] bg-[#00665e]/10"
                  : "border-[#cdeae7] dark:border-opacity-30 hover:border-[#00665e]/50"
              }`}
            >
              <input
                type="radio"
                name="purna_penghasilan_mode"
                value="minimum"
                checked={
                  (formData.purna_penghasilan_mode || "minimum") === "minimum"
                }
                onChange={() =>
                  updateField("purna_penghasilan_mode", "minimum")
                }
                className="w-4 h-4 text-[#00665e] focus:ring-[#00665e]"
              />
              <div>
            ...
            <label
              className={`flex items-center gap-3 p-4 rounded-lg border-2 cursor-pointer transition-all ${
                formData.purna_penghasilan_mode === "langsung"
                  ? "border-[#00665e] bg-[#00665e]/10"
                  : "border-[#cdeae7] dark:border-opacity-30 hover:border-[#00665e]/50"
              }`}
            >
              <input
                ...
                name="purna_penghasilan_mode"
                value="langsung"
                checked={formData.purna_penghasilan_mode === "langsung"}
                onChange={() =>
                  updateField("purna_penghasilan_mode", "langsung")
                }
                className="w-4 h-4 text-[#00665e] focus:ring-[#00665e]"
              />
              <div>
            ...
            <div>
              <label
                ...
                className={`block text-sm font-medium mb-1 ${
                  formData.purna_penghasilan_mode === "langsung"
                    ? "text-[#00665e] dark:text-[#00a89d]"
                    : "text-[#0c1d1b] dark:text-gray-300"
                }`}
              >
                Hak Pensiun Bulanan
                {formData.purna_penghasilan_mode === "langsung" && (
                  <span className="ml-2 text-xs bg-[#00665e] text-white px-2 py-0.5 rounded">
                    Digunakan
                  </span>
                )}
              </label>
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="0"
                  className={`block w-full rounded-lg shadow-sm focus:border-[#00665e] focus:ring-[#00665e] sm:text-sm py-2.5 pl-10 pr-3 text-right font-bold ${
                    formData.purna_penghasilan_mode === "langsung"
                      ? "border-[#00665e] bg-[#00665e]/5 dark:bg-[#00665e]/20"
