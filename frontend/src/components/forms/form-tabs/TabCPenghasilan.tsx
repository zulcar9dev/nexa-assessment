                                ...
                                <div className="flex gap-2 items-center">
                                    ...
                                    <div className="flex items-center h-full pt-1">
                                        <input
                                            ...
                                            className="w-5 h-5 text-[#00665e] border-gray-300 rounded focus:ring-[#00665e]"
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-4">
                            <h4 className="text-md font-semibold text-[#0c1d1b] dark:text-white flex items-center gap-2">
                                <Plus className="w-5 h-5 text-[#00665e]" />
                                Penghasilan Tambahan (Opsional)
                            </h4>
                            <button
                                type="button"
                                onClick={addAdditionalIncome}
                                className="inline-flex items-center gap-1 px-3 py-1.5 bg-[#e6f4f3] text-[#00665e] rounded-lg text-sm font-medium hover:bg-[#d0ebe9] transition-colors"
                            >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                                        <div className="md:col-span-4 mb-2">
                                            ...
                                            <input
                                                ...
                                                className="block w-full text-base font-semibold bg-transparent border-0 border-b-2 border-gray-200 focus:border-[#00665e] focus:ring-0 px-0 py-1 transition-colors bg-[#f8fcfc] dark:bg-[#132b29]"
                                            />
                                        </div>
                                        ...
                                        <div>
                                            <div className="flex flex-col gap-1 mb-1">
                                                ...
                                                <input
                                                    ...
                                                    placeholder="Nama Bulan"
                                                    className="block w-full rounded-md border-gray-200 text-xs py-1 px-2 bg-white dark:bg-[#0f2322]/50 focus:border-[#00665e] focus:ring-[#00665e]"
                                                />
                                            </div>
                                            <div className="flex gap-2 items-center">
                                                <div className="relative flex-1">
                                                    ...
                                                    <input
                                                        ...
                                                        className="block w-full rounded-lg border-[#cdeae7] shadow-sm focus:border-[#00665e] focus:ring-[#00665e] sm:text-sm py-2 pl-9 pr-3 text-right bg-white dark:bg-[#0f2322]/50"
                                                    />
                                                </div>
                                                <div className="flex items-center h-full">
                                                    <input
                                                        ...
                                                        className="w-4 h-4 text-[#00665e] border-gray-300 rounded focus:ring-[#00665e]"
                                                        title="Hitung dalam RPC"
                                                    />
                                                </div>
                                            </div>
