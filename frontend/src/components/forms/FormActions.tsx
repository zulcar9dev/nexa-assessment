            ...
            <div className="max-w-6xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
                ...
                <div className="flex w-full sm:w-auto gap-3">
                    ...
                    <button
                        type="button"
                        onClick={onPreview}
                        className="flex-1 sm:flex-none px-6 py-2.5 border border-brand text-brand font-bold rounded-lg hover:bg-brand/5 transition-colors flex items-center justify-center gap-2"
                    >
                    ...
                    {onSaveDraft && (
                        <button
                            ...
                            className="flex-1 sm:flex-none px-6 py-2.5 border border-[#0f172a] text-accent font-bold rounded-lg hover:bg-accent/5 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                        >
                    ...
                    <button
                        ...
                        onClick={onSave}
                        disabled={isSubmitting}
                        className="flex-1 sm:flex-none px-8 py-2.5 bg-brand text-white font-bold rounded-lg hover:bg-brand-dark shadow-lg shadow-[#4f46e5]/30 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                    >
                        <Save className="w-4 h-4" />
                        Simpan
                    </button>
