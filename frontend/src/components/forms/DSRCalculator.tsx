            ...
            <div className="flex-1 w-full">
                <div className="flex justify-between items-end mb-2">
                    <div>
                        ...
                        <p className="text-xs text-[#45a199] dark:text-[#80cbc4]">Ratio of monthly debt payments to income.</p>
                    </div>
                    <div className="text-right">
                        <span className={`text-2xl font-black ${isValid ? "text-[#00665e] dark:text-[#80cbc4]" : "text-red-500"}`}>
                            {dsrValue.toFixed(1)}%
                        </span>
                        <span className="text-sm font-medium text-[#45a199] dark:text-[#80cbc4]"> / {limit}% Limit</span>
                    </div>
                </div>
                ...
                <div className="flex justify-between mt-1">
                    <span className="text-xs font-bold text-[#00665e] dark:text-[#80cbc4]">Safe (Aman)</span>
