...
export const DOCUMENT_PLACEHOLDERS = [
    ...
    { label: "Status Kepegawaian Manual", value: "{{status_kepegawaian_manual}}" },
    ...
    { label: "Budget Allocation (Investigasi)", value: "{{plafon}}" },
    ...
    { label: "Plafon Maks / Maksimum Kredit", value: "{{plafon_maks}}" },
    { label: "Outstanding (Fasilitas)", value: "{{outstanding}}" },
    { label: "Angsuran (Fasilitas)", value: "{{angsuran}}" },
    { label: "Rating (Fasilitas)", value: "{{kolektibilitas}}" },
    ...
    // 3a. VERIFIKASI PENGHASILAN (LIST)
    { label: "List Verifikasi Penghasilan Purna", value: "{{#list_verifikasi_penghasilan_purna}}" },
    { label: "List Verifikasi Penghasilan Prapurna", value: "{{#list_verifikasi_penghasilan_prapurna}}" },
    { label: "List Verifikasi Penghasilan Aktif", value: "{{#list_verifikasi_penghasilan_aktif}}" },
    ...
    { label: "Tujuan Call", value: "{{tujuan_call}}" },
    { label: "Tujuan Verifikasi", value: "{{tujuan_verifikasi}}" },
    { label: "Tipe Penghasilan Label", value: "{{income_type_label}}" },
    ...
    { label: "List RPC Fleksi Aktif", value: "{{list_rpc_aktif}}" },
    ...
    { label: "Service Fee (Nominal)", value: "{{biaya_provisi}}" },
    { label: "Service Fee (%)", value: "{{biaya_provisi_percent}}" },
    { label: "Biaya Tata Laksana (Nominal)", value: "{{biaya_tatalaksana}}" },
    { label: "Biaya Tata Laksana (%)", value: "{{biaya_tatalaksana_percent}}" },
    { label: "Insurance Fee (Nominal)", value: "{{biaya_psjt}}" },
    { label: "Insurance Fee (%)", value: "{{biaya_psjt_percent}}" },
    ...
    { label: "Perusahaan Sebelumnya", value: "{{prev_instansi}}" },
    { label: "Status Kepegawaian Sebelumnya", value: "{{prev_status_kepegawaian}}" },
    { label: "Masa Kerja Sebelumnya", value: "{{prev_masa_kerja}}" },
    { label: "Tanggal Mulai Kerja Sebelumnya", value: "{{prev_tgl_mulai_kerja}}" },
    { label: "No SK/SPK Sebelumnya", value: "{{prev_no_sk}}" },
    { label: "Tanggal SK/SPK Sebelumnya", value: "{{prev_tgl_sk}}" },
    { label: "No Surat Pengalihan Pekerja", value: "{{no_surat_pengalihan}}" },
    { label: "Tanggal Surat Pengalihan Pekerja", value: "{{tgl_surat_pengalihan}}" },

    // 7a. DATA VERIFIKASI
    { label: "Nama Bendahara", value: "{{nama_bendahara}}" },
    { label: "No HP Bendahara", value: "{{no_hp_bendahara}}" },
    { label: "Nama SDM/Kepegawaian", value: "{{nama_sdm}}" },
    { label: "No HP SDM/Kepegawaian", value: "{{no_hp_sdm}}" },
