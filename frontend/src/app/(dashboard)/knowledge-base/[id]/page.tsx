    ...
    if (error || !doc) {
        return (
            <div className="card p-12 text-center animate-fade-in">
                ...
                <Link
                    href="/knowledge-base"
                    className="inline-flex items-center gap-2 px-4 py-2 bg-[#00665e] hover:bg-[#004d47] !text-white rounded-lg text-sm transition-all"
                >
                    ...
                    <div className="flex items-center gap-3 min-w-0 flex-1">
                        ...
                        <div className="min-w-0">
                            <div className="flex items-start gap-2 flex-wrap">
                                <h1 className="text-lg font-bold text-[#00665e] dark:text-[#80cbc4] break-words">
                                    {doc.judul}
                                </h1>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                ...
                <div className="space-y-4">
                    ...
                    <div className="card p-4 space-y-4">
                        <h3 className="text-sm font-bold text-[#00665e] dark:text-[#80cbc4] flex items-center gap-2">
                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <span className="inline-flex px-2 py-0.5 rounded-full text-xs font-medium bg-[#e0f2f1] text-[#00665e] dark:bg-[#00665e]/20 dark:text-[#80cbc4]">
                    ...
                    {versions.length > 0 && (
                        <div className="card p-4">
                            <h3 className="text-sm font-bold text-[#00665e] dark:text-[#80cbc4] mb-3">
                                📁 Versi Lain
                            </h3>
                                ...
                                {versions.map((v) => (
                                    <Link
                                        ...
                                        className={`block p-2.5 rounded-lg border transition-all duration-200
                                            ${v.id === doc.id
                                                ? "border-[#00665e] bg-[#e0f2f1] dark:bg-[#00665e]/10 dark:border-[#80cbc4]"
                                    ...
                                    >
                                        ...
                                        {v.id === doc.id && (
                                            <span className="text-[10px] text-[#00665e] dark:text-[#80cbc4] font-medium">
                                                ← Sedang dilihat
                                            </span>
                                        )}
                                    </Link>
