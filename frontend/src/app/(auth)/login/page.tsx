        ...
        <div className="relative flex h-full flex-col justify-between p-12 xl:p-16">
          ...
          <div className="max-w-lg">
            ...
            <p className="text-lg xl:text-xl font-medium text-white leading-relaxed drop-shadow-md">
              Portal Internal untuk Karyawan BNI. Kelola pengajuan kredit,
              periksa skor kredit, dan proses persetujuan dengan efisien.
            </p>
          </div>
            ...
            <div className="mb-6 flex items-start gap-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 p-4 border border-amber-200 dark:border-amber-800">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700 dark:text-amber-400 leading-relaxed">
                  Anda telah logout otomatis karena tidak ada aktivitas selama
                  10 menit. Silakan login kembali.
                </p>
              </div>
            </div>
          )}
          ...
          <div className="mt-6 border-t border-gray-200 dark:border-gray-700 pt-4">
            <div className="flex items-start gap-3 rounded-lg bg-amber-50 dark:bg-amber-900/20 p-4 border border-amber-200 dark:border-amber-800">
              ...
              <p className="text-sm text-amber-800 dark:text-amber-300 leading-relaxed">
                <strong className="font-semibold">Peringatan Keamanan:</strong>{" "}
                Akses tidak sah dilarang dan dipantau. Pastikan Anda terhubung
                ke jaringan internal yang aman.
              </p>
            </div>
          </div>
      ...
      fallback={
        <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#1e293b]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-[#00665e] font-medium text-sm animate-pulse">
              Memuat...
            </p>
          </div>
        </div>
