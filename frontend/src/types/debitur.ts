...
export interface DebiturFormData {
  ...
  tukin?: string; // Tunjangan Kinerja (Fleksi Aktif) - Legacy
  uang_makan?: string; // Uang Makan (Fleksi Aktif) - Legacy
  ...
  purna_penghasilan_mode?: "minimum" | "langsung"; // [NEW] Mode perhitungan penghasilan Purna
