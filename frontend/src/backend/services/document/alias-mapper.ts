...
export class AliasMapper {
  static map(context: Record<string, unknown>, client: ClientData): Record<string, unknown> {
    const aliases: Record<string, unknown> = {
      ...
      masa_kerja_text: getMasaKerjaText(client),
      Masa_Kerja_Text: getMasaKerjaText(client),
      ...
      plafon_maks: context.usulan_plafon,
      Plafon_Maks: context.usulan_plafon,
      Tenor: context.tenor,
      ...
      Nama_Almarhum_Pasangan: context.nama_almarhum_pasangan,
      ...
      Tujuan_Call: context.tujuan_call,
      Tujuan_Call_Typo: context.tujuan_call_typo,
      Tujuan_Verifikasi: context.tujuan_verifikasi,
      Income_Type_Label: context.income_type_label,
