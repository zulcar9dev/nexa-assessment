...
export class DocumentService {
     ...
     * 
     * @param debitur - Debitur data with dataLengkap JSON
     * @returns Prepared context for template rendering
     */
    static prepareTemplateContext(debitur: {
        namaPemohon: string;
        noKtp: string;
        kategori: string;
        ...
        const data = debitur.dataLengkap as Record<string, unknown>;
        ...
        return {
            ...formattedData,
            nama_pemohon: debitur.namaPemohon,
            no_ktp: debitur.noKtp,
            kategori: debitur.kategori,
            jenis_pengajuan: debitur.jenisPengajuan,
    ...
    /**
     * Generate simple DOCX document from debitur data
     * This is a fallback when template processing is not available
     * 
     * @param data - Debitur data
    ...
    static async generateSimpleDocx(data: {
        ...
        const doc = new Document({
            sections: [{
                ...
                children: [
                    new Paragraph({
                        text: 'FORMULIR PENGAJUAN KREDIT KONSUMER BNI',
                    ...
                    this.createDataRow('Nama Pemohon', data.namaPemohon),
                    this.createDataRow('NIK', data.noKtp),
                    ...
                    // Section E: Usulan Kredit
                    new Paragraph({
                        text: 'E. USULAN KREDIT',
                        heading: HeadingLevel.HEADING_2,
                    }),
                    this.createDataRow('Plafon Kredit', context.usulan_plafon_kredit_formatted as string || '-'),
     ...
     * 
     * @param kategori - Debitur category
